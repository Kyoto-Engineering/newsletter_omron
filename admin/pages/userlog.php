 ...
 <?php 
  ...
  ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Client Login Details</h1>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
       ...
       <?php
    $getAllinfo = $post->getAlluserinfo();
    if ($getAllinfo ) {
      $i = "0";
...
<div class="row">
 <?php 
        ...
        $total_pages = ceil($total_rows/$per_page);
          ...
          echo "<span class='pagination' style='margin-left:482px;'><a href='userlog.php?page=1'>".'First Page'."</a>";
          for ($i=1; $i <=$total_pages ; $i++) { 
            echo "<a href='userlog.php?page=".$i."'>".$i."</a>";
          };

         echo "<a href='userlog.php?page=$total_pages'>".'last Page'."</a></span>"?>
         </div>
    </div>
    <!-- /#wrapper -->
